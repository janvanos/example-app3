...
@section('content')
    <header class="max-w-xl mx-auto mt-20 text-center">
        ...
        <h2 class="inline-flex mt-2">By Lary Laracore
            <img src="{{ asset('images/lary-head.svg') }}" alt="Head of Lary the mascot">
        </h2>
        ...
        <article class="transition-colors duration-300 hover:bg-gray-100 border border-black border-opacity-0 hover:border-opacity-5 rounded-xl">
            <div class="py-6 px-5 lg:flex">
                <div class="flex-1 lg:mr-8">
                    <img src="{{ asset('images/' . $featured['image']) }}" alt="Blog Post illustration" class="rounded-xl">
                </div>
                ...
                <div class="flex-1 flex flex-col justify-between">
                    <header class="mt-8 lg:mt-0">
                        ...
                        <div class="mt-4">
                            ...
                            <span class="mt-2 block text-gray-400 text-xs">
                                Published <time>{{ $featured['published'] }}</time>
                            </span>
                        </div>
                    </header>
                    ...
                    <footer class="flex justify-between items-center mt-8">
                        ...
                        <div class="hidden lg:block">
                            <a href="{{ route('post.show', $featured['id']) }}"
